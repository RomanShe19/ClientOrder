...
const navItems = [
  ...
  { to: '/admin/leads', label: 'Заявки', icon: LeadsIcon },
  { to: '/admin/admins', label: 'Админы', icon: AdminsIcon, superadminOnly: false },
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-60 bg-gray-900 text-white flex flex-col z-40">
      <div className="px-5 py-5 border-b border-gray-700/50">
        <h1 className="text-lg font-bold tracking-tight">AutoVIP</h1>
